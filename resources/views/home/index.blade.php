    ...
    <div class="flex-fill">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="seo-banner-text">
                            <span>{{ __('We have been working in marketing since 2011') }}</span>
                            <h1>{{ __("Short link service") }}</h1>
                            <p>{{ __("Like a coat rack in a theater, every newsletter starts with a path") }}({{ __("web address") }})</p>

                            <div class="seo-banner-btn">
                                <a href="#contact" class="default-btn seo-btn-bg1 mr-2">{{ __("Subscribe") }}</a>
                                <a href="#contact" class="default-btn seo-btn-bg2 ">{{ __("Learn more") }}</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="saas-service-card seo-services-1">
                            ...
                            <h3>{{ __("Branding and personalization") }}</h3>
                            <p>{{ __("Increase your link click-through rates with branded links using your domain.") }}</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="saas-service-card seo-services-1">
                            ...
                            <h3>А/B {{ __("tests and analytics") }}</h3>
                            <p>{{__("Convenient audience analysis, as well as the ability to conduct A/B tests and targeting.")}}</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0">
                        <div class="saas-service-card seo-services-1">
                            ...
                            <h3>{{ __("Simple and intuitive interface") }}</h3>
                            <p>{{ __("Forget about confusing words and complicated ways to create a short link. It's easy with us!")}}</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="about-us-text">
                            <div class="section-title">
                                <span>{{ __("Creating Short Links")}}</span>
                                <h2>{{ __("Create a short link in 3 clicks")}}</h2>
                            </div>

                            <div class="about-text">
                                <p>{{__("The simple and clear appearance of the admin panel will allow you to solve this problem as quickly as possible, and will also show detailed analytics on transitions through your link.")}}</p>
                            </div>

                            <div class="about-btn">
                                <a href="#" class="default-btn">{{__("Application")}}</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="services" class="our-services-area pt-100 pb-70">
            <div class="container">
                <div class="section-title">
                    ...
                    <h2>{{__('Use all our functionality')}}</h2>
                    <p>{{__("Convenient and simple interface of our personal account software.")}}</p>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="our-service-card">
                            ...
                            <h3>{{__('Link management')}}</h3>
                            <p> {{__('"Creating and managing short links is easy and simple using the functions available in the admin panel after logging in."')}}</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="our-service-card">
                            ...
                            <h3>{{__('Statistics')}}</h3>
                            <p> {{__("Advanced analytics allows you to understand what's happening with your links so you know where you can improve and get higher click-through rates on your short links.")}}</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="our-service-card">
                            ...
                            <h3>{{__("Your domain")}}</h3>
                            <p>{{__("Shorten links with your own branded domain, increasing your click-through rate.")}}</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="our-service-card">
                            ...
                            <h3>{{__("Teamwork")}}</h3>
                            <p>{{__("Provide access to your constellations to other users, they will be able to view analytics, your Pixels, and download it.")}}</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="our-service-card">
                            ...
                            <h3>{{__("Targeting")}}</h3>
                            <p>{{__("Target your audience differently depending on the country of click, device or language used.")}}</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="our-service-card">
                            ...
                            <h3>API</h3>
                            <p>{{__("Use our link shortening service inside your software - reduce time costs to a minimum, while getting maximum results.")}}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="who-we-area ptb-100">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="section-title">
                            <span>{{__('Short link service')}}</span>
                            <h3>{{__("Use Deep Linking to redirect the user")}}</h3>
                        </div>

                        <div class="who-we-are-text">
                            <p>{{__("Deep Linking allows you to make the link smarter and “redirect” the user from the website to the mobile application, if installed, or to the App Store/Google Play, if not.")}}</p>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5">
                        <div class="chooses-img-contant">
                            <div class="section-title">
                                <span>{{__("Shorten link")}}</span>
                                <h2>{{__("Complete set of marketers")}}</h2>
                                <p>{{__("Numbers are everything! Analyze your mailing data using our service. It includes:")}}</p>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-6">
                                    <div class="choose-card">
                                        ...
                                        <h3>{{__("Spaces")}}</h3>
                                        <p>{{__("Short links are like little stars in the boundless sky, so as not to lose them - combine short links into Constellations (catalog). Sort links quickly and correctly.")}}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-sm-6">
                                    <div class="choose-card">
                                        ...
                                        <h3>Pixel</h3>
                                        <p>{{__("Perhaps more than one modern marketer cannot live without this option. Use Pixel if you need to link, target or retarget something.")}}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-sm-6">
                                    <div class="choose-card">
                                        ...
                                        <h3>{{__("Export")}}</h3>
                                        <p>{{__("Export all links and all statistics on them to a CSV file at any time in seconds.")}}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-sm-6">
                                    <div class="choose-card">
                                        ...
                                        <h3>{{__("UTM tags")}}</h3>
                                        <p>{{__("Create UTM tags within our service to improve usability and traceability.")}}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div id="pricing" class="our-pricing-area pt-100 pb-70">
            <div class="container">
                <div class="section-title">
                    <span>{{__("Short link service")}}</span>
                    <h2>{{__("Subscription cost")}}</h2>
                    <p><strong>{{__("If you need to find out the cost of a service for mailing from 50,000 recipients, as well as with enhanced protection against hacking, cheating, follow the link -")}}<a href="">{{__("business client")}}</a>.</p>
                    </strong></div>

                <div class="tab pricing-tab">
                    <ul class="tabs">
                        <li class="mr-3">{{__("Price per month")}}</li>
                        <li>{{__("Price per year")}}</li>
                        <li class="save-card"><span>{{__("Discount up to")}}</span>50%</li>
                    </ul>
                                    ...
                                    <div class="prising-card pric-tabe">
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                {{__("Suitable for mailing to up to 10,000 recipients")}}
                                            </li>
                                            <li>
                                                <i class="las la-check"></i>
                                                10 {{__("links")}}
                                        ...
                                        <div class="price-btn text-center">
                                            <a href="#contact" class="default-btn bg-color">{{__("To plug")}}</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="prising-card pric-tabe">
                                        ...
                                        <ul>
                                            <li>
                                                <i class="las la-check"></i>
                                                {{__("Suitable for mailing to up to 25,000 recipients")}}
                                            </li>
                                            <li>
                                                <i class="las la-check"></i>
                                                25 {{__("links")}}
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6 offset-sm-3 offset-lg-0">
                                    <div class="prising-card pric-tabe">
                                        ...
                                        <ul>
                                            <li>
                                                <i class="las la-check"></i>
                                                {{__("Suitable for mailing to up to 50,000 recipients")}}
                                            </li>
                                            <li>
                                                <i class="las la-check"></i>
                                                50 {{__("links")}}
        ...
        <div id="case-study" class="case-study-area pt-100 pb-70">
            <div class="container">
                <div class="section-title">
                    <span>{{ __('Shorten your link') }}</span>
                    <h2>{{__("Successful cases")}}</h2>
                    <p>{{__("Get to know us through the prism of our projects.")}}</p>
                </div>
                                ...
                                <div class="d-table">
                                    <div class="d-table-cell">
                                        <div class="study-text">
                                            <h3>{{__("Real estate agency")}}</h3>
                                            <p>{{__("Increased the number of link clicks (CTR) by 1.5 times due to the branded domain.")}}</p>
                        ...
                        <div class="case-study-card">
                            ...
                            <div class="caption">
                                <div class="d-table">
                                    <div class="d-table-cell">
                                        <div class="study-text">
                                            <h3>{{__("Pizza and Sushi")}}</h3>
                                            <p>{{__("Using Deep Linking we were able to increase the number of downloads of mobile applications via mailing lists.")}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="case-study-card">
                            ...
                            <div class="caption">
                                <div class="d-table">
                                    <div class="d-table-cell">
                                        <div class="study-text">
                                            <h3>{{__("Logistics center")}}</h3>
                                            <p>{{__("Based on A/B testing data, we were able to develop higher quality and conversion content.")}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="case-study-card">
                            ...
                            <div class="caption">
                                <div class="d-table">
                                    <div class="d-table-cell">
                                        <div class="study-text">
                                            <h3>{{__("Flower shop")}}</h3>
                                            <p>{{__("Using Pixel, we targeted advertising to mailing recipients, which increased conversion by 2.3%.")}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="case-study-card">
                            ...
                            <div class="caption">
                                <div class="d-table">
                                    <div class="d-table-cell">
                                        <div class="study-text">
                                            <h3>{{__("Sanitary engineering shop")}}</h3>
                                            <p>{{__("Using the API, I integrated the CLIK.by service into my SMS mailings for clients.")}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="case-study-card">
                            ...
                            <div class="caption">
                                <div class="d-table">
                                    <div class="d-table-cell">
                                        <div class="study-text">
                                            <h3>{{__("A fitness center")}}</h3>
                                            <p>{{__("Statistics, Pixels, Deep Linking, UTM tag constructor and link lifetime - used in working with mailing lists.")}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div id="testimonials" class="testimonials-area pt-100 pb-70">
            <div class="container">
                <div class="section-title">
                    <span>{{ __("Short link service") }}</span>
                    <h2>{{__("Solution for you")}}</h2>
                    <p>{{__("Still hesitant to shorten a couple of links with us? Read our business solutions:")}}</p>
                </div>

                <div class="testimonials-slider owl-carousel owl-theme">
                    <div class="testimonials-slider-item">
                        <img src="assets/images/seo-img/client1.jpg" alt="Image">
                        <h3>{{__("Online store")}}</h3>
                        <div class="rating">
        ...
        <div id="contact" class="contact-area ptb-100">
            <div class="container">
                <div class="section-title">
                    <h2>{{__("Contacts")}}<img src="assets/images/writehand.gif" alt="hand" style="width:48px;"></h2>
                    <p>{{__("Leave a request and we will contact you")}} 💙</p>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" name="name" class="form-control" id="name" required data-error='{{__("Please enter your name")}}' placeholder='{{__("your name")}}'>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="email" name="email" class="form-control" id="email" required data-error='{{__("Please enter your e-mail")}}' placeholder='{{__("Your email address")}}'>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" name="msg_subject" id="msg_subject" class="form-control" required data-error='{{__("Please enter your website address or topic")}}' placeholder='{{__("Your website address or email subject...")}}'>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" name="phone_number" class="form-control" id="phone_number" required data-error='{{__("Please enter your phone number")}}' placeholder='{{__("Phone number...")}}'>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    <textarea name="message" id="message" class="form-control" cols="30" rows="6" required data-error='{{__("Please enter a message")}}' placeholder='{{__("Your message...")}}'></textarea>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>

                            <div class="col-lg-12 col-md-12 text-center">
                                <button type="submit" class="default-btn">{{__("Send")}}</button>
